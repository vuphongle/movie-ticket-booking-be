...
public class ValidationMessages {
  ...
  public static final String INVALID_TIME_RANGE =
      "Thời gian áp dụng không hợp lệ (ngày bắt đầu phải trước ngày kết thúc).";
  public static final String CANNOT_ACTIVATE_NO_ENABLED_DETAILS =
      "Không thể kích hoạt: cần ít nhất 1 dòng chi tiết kích hoạt và hợp lệ.";
  ...
  public static final String CART_NOT_MEET_CONDITIONS =
      "Giỏ hàng chưa đáp ứng điều kiện của khuyến mãi.";
  ...
  public static final String CANNOT_DELETE_USED_DETAIL =
      "Coupon detail đã được sử dụng không thể xóa.";
  public static final String CANNOT_REDUCE_USAGE_LIMIT =
      "Không thể đặt usage limit nhỏ hơn số lượng đã sử dụng.";

  // Success messages
  public static final String COUPON_APPLIED_SUCCESSFULLY =
      "Áp dụng thành công cho toàn bộ đơn hàng.";
