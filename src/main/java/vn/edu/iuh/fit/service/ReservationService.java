...
public class ReservationService {
  ...
  public void reserveSeat(SeatReservationRequest request) {
    ...
    if (seatReservationRepository.existsBySeat_IdAndShowtime_IdAndStatusIn(
        ...
        List.of(SeatReservationStatus.HELD, SeatReservationStatus.BOOKED))) {
    ...
    SeatReservationResponse response =
        SeatReservationResponse.builder()
  ...
  public void cancelReservation(SeatReservationRequest request) {
    SeatReservation reservation =
        seatReservationRepository
            .findBySeat_IdAndShowtime_IdAndStatus(
                request.getSeatId(), request.getShowtimeId(), SeatReservationStatus.HELD)
  ...
  public void cancelMultipleReservations(CancelMultipleSeatsRequest request) {
    List<SeatReservation> reservations =
        seatReservationRepository.findByShowtime_IdAndSeat_IdInAndStatus(
            request.getShowtimeId(), request.getSeatIds(), SeatReservationStatus.HELD);
