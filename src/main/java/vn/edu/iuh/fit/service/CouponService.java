...
public class CouponService {
  ...
  public List<CouponResponse> getAllCoupons() {
    ...
    return coupons.stream().map(this::buildCouponResponse).collect(Collectors.toList());
  }
  ...
  public Coupon createCoupon(UpsertCouponRequest request) {
    ...
    if (request.getStatus()) {
      throw new BadRequestException(
          "Coupon mới tạo phải có trạng thái ẩn. Sau khi tạo và thêm điều kiện chi tiết, bạn có thể kích hoạt coupon.");
    }
