...
public class ProductService {
  ...
  public Page<Product> searchProducts(String name, Boolean status, int page, int size) {
    log.info(
        "Search products with filters - name: {}, status: {}, page: {}, size: {}",
        name,
        status,
        page,
        size);
  ...
  public void deleteProduct(Integer id) {
    ...
    if (additionalServiceItemRepository.existsByProductId(id)) {
      throw new IllegalArgumentException(
          "Cannot delete product. It is being used in additional services.");
    }
  ...
  public Product toggleProductStatus(Integer id) {
    ...
    if (product.getStatus() && !checkProductConstraints(id)) {
      throw new IllegalArgumentException(
          "Cannot deactivate product. It is being used in active promotions or additional services.");
    }
  ...
  private boolean checkProductConstraints(Integer productId) {
    ...
    if (additionalServiceItemRepository.existsByProductIdAndAdditionalServiceStatusTrue(
        productId)) {
    ...
    if (couponDetailTermsRepository.existsByGiftServiceIdAndEnabledTrueAndCouponStatusTrue(
        productId)) {
