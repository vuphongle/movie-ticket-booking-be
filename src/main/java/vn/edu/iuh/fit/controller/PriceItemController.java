...
public class PriceItemController {
    ...
    public ResponseEntity<?> getPriceItemById(@PathVariable Integer id) {
        ...
        return priceItem.map(ResponseEntity::ok)
    ...
    public ResponseEntity<?> updatePriceItem(@PathVariable Integer id, 
                                           @Valid @RequestBody PriceItemRequest priceItemRequest) {
    ...
    public ResponseEntity<?> getEffectivePriceItemsForAdditionalService(@PathVariable Integer serviceId) {
        List<PriceItem> priceItems = pricingService.getAllValidPriceItemsForAdditionalService(serviceId);
        return ResponseEntity.ok(priceItems);
    }
