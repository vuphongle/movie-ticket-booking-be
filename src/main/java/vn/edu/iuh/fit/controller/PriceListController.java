...
public class PriceListController {
  ...
  public ResponseEntity<?> getPriceListById(@PathVariable Integer id) {
    ...
    return priceList.map(ResponseEntity::ok).orElse(ResponseEntity.notFound().build());
  }
  ...
  public ResponseEntity<?> updatePriceList(
      @PathVariable Integer id, @Valid @RequestBody PriceList priceList) {
  ...
  public ResponseEntity<?> clonePriceList(
      @PathVariable Integer id, @Valid @RequestBody ClonePriceListRequest request) {
    try {
