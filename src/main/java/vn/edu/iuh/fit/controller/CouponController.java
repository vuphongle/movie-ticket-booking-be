...
public class CouponController {
  ...
  public ResponseEntity<?> updateCoupon(
      @PathVariable Integer id, @Valid @RequestBody UpsertCouponRequest request) {
  ...
  public ResponseEntity<?> previewCoupon(
      @PathVariable Integer id, @Valid @RequestBody CouponPreviewRequest request) {
    return ResponseEntity.ok(couponPreviewService.previewCoupon(id, request));
  }

  @PostMapping("/coupons/previews")
  public ResponseEntity<?> previewAllCouponDetail(
