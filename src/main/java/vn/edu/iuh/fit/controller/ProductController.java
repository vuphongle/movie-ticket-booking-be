...
public class ProductController {
  ...
  public ResponseEntity<?> updateProduct(
      @PathVariable Integer id, @Valid @RequestBody UpsertProductRequest request) {
  ...
  public ResponseEntity<?> checkSkuExists(
      @RequestParam String sku, @RequestParam(required = false) Integer excludeId) {
    boolean exists =
        excludeId != null
  ...
  public ResponseEntity<Product> updateProductLegacy(
